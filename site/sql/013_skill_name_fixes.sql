-- Corrections libellés post-normalisation (idempotent)
...
SET s.name = 'Secourisme niveau 3'
WHERE o.code = 'FFESSM' AND l.code = 'N3' AND s.code = 'FFN3-06-RIF' AND s.name <> 'Secourisme niveau 3';
